...
В корне проекта создайте wsgi.py файл,в который просто импортируйте все из wsgi.py файла, который находится в папке с названием вашего проекта


![фвыа](http://images.na4u.ru/static/deploy/26.png)
